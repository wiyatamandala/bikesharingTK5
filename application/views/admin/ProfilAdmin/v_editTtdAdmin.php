...
<form enctype="multipart/form-data" class="form-horizontal" method="POST" action="<?php echo base_url();?>admin/profilAdmin/upload_ttd">
        ...
        <div class="col-md-6 col">
            ...
            <div class="form-group">
                <label class="control-label col-md-3">Tanda Tangan</label>
                    <div class="col-xs-6">
                        <input type="file" name="ttd" id="id-input-file-2" />
